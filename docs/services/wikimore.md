...
For details about configuring the [Ansible role for Wikimore](https://radicle.network/nodes/iris.radicle.network/rad%3Az54oV5qKRrLSArZqdisrD9s7h9BQ), you can check them via:

- 🌐 [the role's documentation](https://radicle.network/nodes/iris.radicle.network/rad%3Az54oV5qKRrLSArZqdisrD9s7h9BQ/tree/docs/configuring-wikimore.md) online
