...
- 🌐 [the role's documentation](https://github.com/mother-of-all-self-hosting/ansible-role-findmydeviceserver/blob/main/docs/configuring-fmd-server.md) online
- 📁 `roles/galaxy/findmydeviceserver/docs/configuring-fmd-server.md` locally, if you have [fetched the Ansible roles](../installing.md)
...
See [this section](https://github.com/mother-of-all-self-hosting/ansible-role-findmydeviceserver/blob/main/docs/configuring-fmd-server.md#usage) on the role's documentation for details about how to set up the client (FMD).
...
See [this section](https://github.com/mother-of-all-self-hosting/ansible-role-findmydeviceserver/blob/main/docs/configuring-fmd-server.md#troubleshooting) on the role's documentation for details.
