...
For details about configuring the [Ansible role for Termix](https://radicle.network/nodes/iris.radicle.network/rad%3Az4TiZiqkm6MBmkPL2NTPMavni6LV), you can check them via:

- 🌐 [the role's documentation](https://radicle.network/nodes/iris.radicle.network/rad%3Az4TiZiqkm6MBmkPL2NTPMavni6LV/tree/docs/configuring-termix.md) online
