...
⚠️ **Warning**: 2FA does not seem to be working in Forgejo. If this is something you require to get working, do know that it's still an unsolved problem. Details for resetting/disabling 2FA are below.
