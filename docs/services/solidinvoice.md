...
For details about configuring the [Ansible role for SolidInvoice](https://radicle.network/nodes/iris.radicle.network/rad%3AzeEwXM9Fp4C8NU4oQfNg474Vivwu), you can check them via:

- 🌐 [the role's documentation](https://radicle.network/nodes/iris.radicle.network/rad%3AzeEwXM9Fp4C8NU4oQfNg474Vivwu/tree/docs/configuring-solidinvoice.md) online
