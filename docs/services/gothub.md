...
For details about configuring the [Ansible role for GotHub](https://radicle.network/nodes/iris.radicle.network/rad%3AzFVv3koKtheJTTwPSjF3J6DajePK), you can check them via:

- 🌐 [the role's documentation](https://radicle.network/nodes/iris.radicle.network/rad%3AzFVv3koKtheJTTwPSjF3J6DajePK/tree/docs/configuring-gothub.md) online
