...
For details about configuring the [Ansible role for MailCatcher](https://radicle.network/nodes/iris.radicle.network/rad%3Az3QmarrgiC7ZGmd7UCTW2EZTheCZb), you can check them via:

- 🌐 [the role's documentation](https://radicle.network/nodes/iris.radicle.network/rad%3Az3QmarrgiC7ZGmd7UCTW2EZTheCZb/tree/docs/configuring-mailcatcher.md) online
