...
For details about configuring the [Ansible role for OrigamiVault](https://radicle.network/nodes/iris.radicle.network/rad%3Az3aGv2oUAxqmoGddtk1VwRioUTKbs), you can check them via:

- 🌐 [the role's documentation](https://radicle.network/nodes/iris.radicle.network/rad%3Az3aGv2oUAxqmoGddtk1VwRioUTKbs/tree/docs/configuring-origamivault.md) online
...
Refer to [this section](https://radicle.network/nodes/iris.radicle.network/rad%3Az3aGv2oUAxqmoGddtk1VwRioUTKbs/tree/docs/configuring-origamivault.md#troubleshooting) on the role's documentation for details.
