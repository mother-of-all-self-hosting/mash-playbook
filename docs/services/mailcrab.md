...
For details about configuring the [Ansible role for MailCrab](https://radicle.network/nodes/iris.radicle.network/rad%3Az3rh69mtu7bBk5K1WmAkVEBTy6NpW), you can check them via:

- 🌐 [the role's documentation](https://radicle.network/nodes/iris.radicle.network/rad%3Az3rh69mtu7bBk5K1WmAkVEBTy6NpW/tree/docs/configuring-mailcrab.md) online
