...
At first, you need to adjust `inventory/hosts` file to add a supplementary host for SearXNG. See [here](../running-multiple-instances.md#1-adjust-hosts) for details.
