...
Some of the services installed by this playbook require a Valkey data store. As this playbook supports [Redis](redis.md) as well, we recommend using Valkey since 2024-11-23.
