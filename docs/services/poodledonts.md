...
For details about configuring the [Ansible role for PoodleDonts](https://radicle.network/nodes/iris.radicle.network/rad%3Az4MgJseWRZ9FL3Mh6ASufmi1RJoVh), you can check them via:

- 🌐 [the role's documentation](https://radicle.network/nodes/iris.radicle.network/rad%3Az4MgJseWRZ9FL3Mh6ASufmi1RJoVh/tree/docs/configuring-poodledonts.md) online
