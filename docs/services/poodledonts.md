...
For details about configuring the [Ansible role for PoodleDonts](https://radicle.network/nodes/seed.radicle.garden/rad%3Az4MgJseWRZ9FL3Mh6ASufmi1RJoVh), you can check them via:

- 🌐 [the role's documentation](https://radicle.network/nodes/seed.radicle.garden/rad%3Az4MgJseWRZ9FL3Mh6ASufmi1RJoVh/tree/docs/configuring-poodledonts.md) online
...
See [this section](https://radicle.network/nodes/seed.radicle.garden/rad%3Az4MgJseWRZ9FL3Mh6ASufmi1RJoVh/tree/docs/configuring-poodledonts.md#troubleshooting) on the role's documentation for details.
