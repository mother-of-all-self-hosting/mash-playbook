...
For details about configuring the [Ansible role for PruneMate](https://radicle.network/nodes/iris.radicle.network/rad%3AzTsddBnXnhE3i4xhzsEX12deb4fx), you can check them via:

- 🌐 [the role's documentation](https://radicle.network/nodes/iris.radicle.network/rad%3AzTsddBnXnhE3i4xhzsEX12deb4fx/tree/docs/configuring-prunemate.md) online
