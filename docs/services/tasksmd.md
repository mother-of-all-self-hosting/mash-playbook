...
See [this section](https://radicle.network/nodes/iris.radicle.network/rad%3Az3BKJz8wwtQHfXm8MPX81h4izT2QS/tree/docs/configuring-mailpit.md#troubleshooting) on the role's documentation for details.
