...
For details about configuring the [Ansible role for BentoPDF](https://radicle.network/nodes/iris.radicle.network/rad%3Az2bgVhWju6shYSwtdKb7v3eoSL1Pt), you can check them via:

- 🌐 [the role's documentation](https://radicle.network/nodes/iris.radicle.network/rad%3Az2bgVhWju6shYSwtdKb7v3eoSL1Pt/tree/docs/configuring-bentopdf.md) online
...
To have the service run as the playbook's default user instead of root user, this service is by default configured to use the Docker image locally built on [this own Dockerfile](https://radicle.network/nodes/iris.radicle.network/rad%3Az2bgVhWju6shYSwtdKb7v3eoSL1Pt/tree/templates/Dockerfile.j2).
...
- [Stirling PDF v1](stirling-pdf.md) — PDF converter
