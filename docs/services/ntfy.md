...
Your UnifiedPush-compatible applications (such as [DAVx⁵](https://www.davx5.com/), [FindMyDevice](https://gitlab.com/fmd-foss/fmd-android/), and [Tusky](https://tusky.app/)) listen to the Distributor, and push notitications are "distributed" from it. This means that the UnifiedPush-compatible applications cannot receive push notifications from the Push Server without the Distributor.
