...
For details about configuring the [Ansible role for InspIRCd](https://radicle.network/nodes/iris.radicle.network/rad%3AzA2EcZYaHBzoc3XudvDhVDBjT42a), you can check them via:

- 🌐 [the role's documentation](https://radicle.network/nodes/iris.radicle.network/rad%3AzA2EcZYaHBzoc3XudvDhVDBjT42a/tree/docs/configuring-inspircd.md) online
