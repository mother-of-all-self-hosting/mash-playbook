...
For details about configuring the [Ansible role for soundcloak](https://radicle.network/nodes/iris.radicle.network/rad%3Az381JyLARWwSiZnYotVXehYcQEw7u), you can check them via:

- 🌐 [the role's documentation](https://radicle.network/nodes/iris.radicle.network/rad%3Az381JyLARWwSiZnYotVXehYcQEw7u/tree/docs/configuring-soundcloak.md) online
