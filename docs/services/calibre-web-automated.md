...
For details about configuring the [Ansible role for Calibre-Web Automated](https://radicle.network/nodes/iris.radicle.network/rad%3AzSfEaojv4NnFnivPm248Lx123CNe), you can check them via:

- 🌐 [the role's documentation](https://radicle.network/nodes/iris.radicle.network/rad%3AzSfEaojv4NnFnivPm248Lx123CNe/tree/docs/configuring-calibre-web-automated.md) online
