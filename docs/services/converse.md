...
For details about configuring the [Ansible role for Converse](https://radicle.network/nodes/iris.radicle.network/rad%3Az22bUmhZzA5VWtmKERFkEjGzdPuke), you can check them via:

- 🌐 [the role's documentation](https://radicle.network/nodes/iris.radicle.network/rad%3Az22bUmhZzA5VWtmKERFkEjGzdPuke/tree/docs/configuring-converse.md) online
...
To use XMPP via HTTP with the client, it is necessary to use a BOSH connection manager or the WebSocket API. Refer to [this section](https://radicle.network/nodes/iris.radicle.network/rad:z22bUmhZzA5VWtmKERFkEjGzdPuke/tree/docs/configuring-converse.md#specify-bosh-websocket-api) on the role's documentation for details.
