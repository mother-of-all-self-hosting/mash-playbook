...
For details about configuring the [Ansible role for bitmagnet](https://radicle.network/nodes/iris.radicle.network/rad%3Azs18Rifa7437q7hTFhsx11nYeGhD), you can check them via:

- 🌐 [the role's documentation](https://radicle.network/nodes/iris.radicle.network/rad%3Azs18Rifa7437q7hTFhsx11nYeGhD/tree/docs/configuring-bitmagnet.md) online
