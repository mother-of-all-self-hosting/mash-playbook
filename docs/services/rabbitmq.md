...
The [Ansible role for RabbitMQ](https://radicle.network/nodes/iris.radicle.network/rad%3Az3PCtuwyz2HdHeKnHCefR253rpYwp) is developed and maintained by the MASH project. For details about configuring RabbitMQ, you can check them via:

- 🌐 [the role's documentation](https://radicle.network/nodes/iris.radicle.network/rad%3Az3PCtuwyz2HdHeKnHCefR253rpYwp/tree/docs/configuring-rabbitmq.md) online
