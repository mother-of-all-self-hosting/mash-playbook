...
For details about configuring the [Ansible role for Ergo](https://radicle.network/nodes/iris.radicle.network/rad%3Az2CSxS3YLtJYM87TyGZkZCan3uoSJ), you can check them via:

- 🌐 [the role's documentation](https://radicle.network/nodes/iris.radicle.network/rad%3Az2CSxS3YLtJYM87TyGZkZCan3uoSJ/tree/docs/configuring-ergo.md) online
