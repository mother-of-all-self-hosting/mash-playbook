...
For details about configuring the [Ansible role for Atuin server](https://radicle.network/nodes/iris.radicle.network/rad%3Az4ATDhf89CPqP7XCLNpNwobuJ9fBs), you can check them via:

- 🌐 [the role's documentation](https://radicle.network/nodes/iris.radicle.network/rad%3Az4ATDhf89CPqP7XCLNpNwobuJ9fBs/tree/docs/configuring-atuin.md) online
