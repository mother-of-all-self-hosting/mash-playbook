...
For details about configuring the [Ansible role for Kanboard](https://radicle.network/nodes/iris.radicle.network/rad%3Az2LZH9TGMxYbGBaGoMHNFX5HymEL3), you can check them via:

- 🌐 [the role's documentation](https://radicle.network/nodes/iris.radicle.network/rad%3Az2LZH9TGMxYbGBaGoMHNFX5HymEL3/tree/docs/configuring-kanboard.md) online
