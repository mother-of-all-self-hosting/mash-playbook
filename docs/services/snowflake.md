...
The [Ansible role for the standalone Snowflake proxy](https://radicle.network/nodes/iris.radicle.network/rad%3Aznvd313jEb23f9AUNmtsweE7YHCK) is developed and maintained by the MASH project. For details about configuring the proxy, you can check them via:

- 🌐 [the role's documentation](https://radicle.network/nodes/iris.radicle.network/rad%3Aznvd313jEb23f9AUNmtsweE7YHCK/tree/docs/configuring-snowflake.md) online
