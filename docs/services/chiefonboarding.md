...
For details about configuring the [Ansible role for ChiefOnboarding](https://radicle.network/nodes/iris.radicle.network/rad%3Az3HYheWh86U9ErEL18tK2gBkq7g2A), you can check them via:

- 🌐 [the role's documentation](https://radicle.network/nodes/iris.radicle.network/rad%3Az3HYheWh86U9ErEL18tK2gBkq7g2A/tree/docs/configuring-chiefonboarding.md) online
...
Refer to [this section](https://radicle.network/nodes/iris.radicle.network/rad:z3HYheWh86U9ErEL18tK2gBkq7g2A/tree/docs/configuring-chiefonboarding.md#configure-the-mailer) on the role's documentation for the details about how to configure the mailer.
