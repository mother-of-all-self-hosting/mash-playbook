...
For details about configuring the [Ansible role for WriteFreely](https://radicle.network/nodes/iris.radicle.network/rad%3Az2i8BkHXzRvK1ZtGwHuvLACRswXgA), you can check them via:

- 🌐 [the role's documentation](https://radicle.network/nodes/iris.radicle.network/rad%3Az2i8BkHXzRvK1ZtGwHuvLACRswXgA/tree/docs/configuring-writefreely.md) online
