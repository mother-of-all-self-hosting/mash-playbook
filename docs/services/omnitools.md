...
OmniTools is a self-hosted web app offering a variety of online tools to simplify everyday tasks.
...
For details about configuring the [Ansible role for OmniTools](https://github.com/mother-of-all-self-hosting/ansible-role-omnitools), you can check them via:

- 🌐 [the role's documentation](https://github.com/mother-of-all-self-hosting/ansible-role-omnitools/blob/main/docs/configuring-omnitools.md) online
