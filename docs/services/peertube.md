...
At first, you need to adjust `inventory/hosts` file to add a supplementary host for PeerTube. See [here](../running-multiple-instances.md#1-adjust-hosts) for details.
