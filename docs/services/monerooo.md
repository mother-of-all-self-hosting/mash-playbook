...
For details about configuring the [Ansible role for Moner.ooo](https://radicle.network/nodes/iris.radicle.network/rad%3Az3i2ogEXxuSzVAxVaRuoydAiDCBKi), you can check them via:

- 🌐 [the role's documentation](https://radicle.network/nodes/iris.radicle.network/rad%3Az3i2ogEXxuSzVAxVaRuoydAiDCBKi/tree/docs/configuring-monerooo.md) online
...
Refer to [this section](https://radicle.network/nodes/iris.radicle.network/rad%3Az3i2ogEXxuSzVAxVaRuoydAiDCBKi/tree/docs/configuring-monerooo.md#troubleshooting) on the role's documentation for details.
