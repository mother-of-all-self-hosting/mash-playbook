...
For details about configuring the [Ansible role for Gotify](https://radicle.network/nodes/iris.radicle.network/rad%3Az3dQNNLitS9sByxZ83ivu5qg6qR4N), you can check them via:

- 🌐 [the role's documentation](https://radicle.network/nodes/iris.radicle.network/rad%3Az3dQNNLitS9sByxZ83ivu5qg6qR4N/tree/docs/configuring-gotify.md) online
...
You also need to set an initial username and password for the first user. Refer to [this section](https://radicle.network/nodes/iris.radicle.network/rad%3Az3dQNNLitS9sByxZ83ivu5qg6qR4N/tree/docs/configuring-gotify.md#specify-username-and-password-for-the-first-user) on the role's documentation.
