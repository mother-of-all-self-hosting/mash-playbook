...
For details about configuring the [Ansible role for flatnotes](https://radicle.network/nodes/iris.radicle.network/rad%3Az49LkutSMcaLA2DBazn1h4V6Pn6GK), you can check them via:

- 🌐 [the role's documentation](https://radicle.network/nodes/iris.radicle.network/rad%3Az49LkutSMcaLA2DBazn1h4V6Pn6GK/tree/docs/configuring-flatnotes.md) online
