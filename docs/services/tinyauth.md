...
For details about configuring the [Ansible role for Tinyauth](https://radicle.network/nodes/iris.radicle.network/rad%3AzLMiPKSyMcb5m85H2brZd4GHCDTF), you can check them via:

- 🌐 [the role's documentation](https://radicle.network/nodes/iris.radicle.network/rad%3AzLMiPKSyMcb5m85H2brZd4GHCDTF/tree/docs/configuring-tinyauth.md) online
...
Refer to [this section](https://radicle.network/nodes/iris.radicle.network/rad%3AzLMiPKSyMcb5m85H2brZd4GHCDTF/tree/docs/configuring-tinyauth.md#prerequisites) on the role's documentation for details.
