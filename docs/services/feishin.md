...
For details about configuring the [Ansible role for Feishin](https://radicle.network/nodes/iris.radicle.network/rad%3Azmszzm7ynZe8nt5ZwaLctssyJcNm), you can check them via:

- 🌐 [the role's documentation](https://radicle.network/nodes/iris.radicle.network/rad%3Azmszzm7ynZe8nt5ZwaLctssyJcNm/tree/docs/configuring-feishin.md) online
...
By default one can have Feishin connect to any server as specified. Refer to [this section](https://radicle.network/nodes/iris.radicle.network/rad%3Azmszzm7ynZe8nt5ZwaLctssyJcNm/tree/docs/configuring-feishin.md#enabling-server-lock-optional) on the role's documentation about how to activate "server lock".
